<template>
  <v-container>
    <expenses-header title="Gastos varios"  />
    <v-card>
      <v-data-table
        :items="items"
        :headers="headers"
...
import CreateExpensesDialog from '~/components/Dialogs/Expenses/ExpensesDialog.vue'
import ExpensesHeader from '~/components/SharedComponents/SharedHeader.vue'
import moment from 'moment'
export default {
  components: { CreateExpensesDialog, ExpensesHeader, JsonExcel },
  computed: {
    items: {
      get() {
